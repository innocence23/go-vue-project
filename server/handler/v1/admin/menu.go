...
func (h *menuHandler) treeList(c *gin.Context) {
	...
	// fmt.Printf("==========%+v", c)
	// fmt.Println("==========", c)
	// fmt.Println("======0000)))))))0000====", utils.GetUserRoleId(c))
	// fmt.Println("======00000000====", utils.GetUserRoleId(c)[0])
